...
SUPERVISOR_SYSTEM_PROMPT = (
    ...
    "- 'sql': Use ONLY when the question refers to columns and tables in the SQL Database Schema below.\n"
    "- 'rag': Use when the question is about uploaded files (including CSVs, spreadsheets, PDFs). If the query refers to a filename in the 'Available Documents' list (e.g., 'SuperMarket Analysis.csv' or sales CSV data), you MUST route to 'rag'.\n"
